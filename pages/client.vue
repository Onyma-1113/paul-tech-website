  ...
  <form class="font-[sans-serif] text-[#333] max-w-4xl w-full px-6 my-10">
        <div class="grid sm:grid-cols-2 gap-10">
          <div class="relative flex items-center">
            <label class="text-[13px] absolute top-[-10px] left-0">First Name</label>
          ...
          <div class="relative flex items-center">
            <label class="text-[13px] absolute top-[-10px] left-0">Last Name</label>
          ...
          <div class="relative flex items-center sm:col-span-2">
            <label class="text-[13px] absolute top-[-10px] left-0">Phone</label>
          ...
          <div class="relative flex items-center sm:col-span-2">
            <label class="text-[13px] absolute top-[-10px] left-0">Email</label>
