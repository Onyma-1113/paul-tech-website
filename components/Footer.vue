<template>
  ...
  <g class="cls-12">
    ...
    <div class="h-full flex flex-col justify-around">
      ...
      <div class="flex items-center">
        ...
        <NuxtLink to="https://x.com/"> <img src="../assets/img/pngwing.com (2).png" alt="" srcset="" class="h-24"></NuxtLink>
  ...
  <div class=" lg:flex w-screen h-fifty-vh bg-[#010923] flex flex-col justify-between items-center px-10 lg:hidden border-t-2">
    
    
      <div class="h-full flex flex-col justify-between items-center flex-wrap gap-5 pt-2">
        <li>
