<template>
  ...
  <div class=" lg:flex w-screen h-fourty-vh bg-[#010923] flex flex-col justify-between items-center px-10 lg:hidden border-t-2">
  ...
  <g class="cls-12">
    ...
    <rect class="cls-2" x="674.74" y="329.27" width="222.9" height="408.65"/>
      ...
      <div class="h-full flex flex-col justify-between items-center flex-wrap gap-5">
        <li>
          <NuxtLink to="/about">{{$t('redirection_title_about')}}</NuxtLink>
        </li>
        <li>
